...
def test_get_one_post_not_exist(authorized_client,test_posts):
    ...
    res = authorized_client.get(f"/posts/9876")
...
@pytest.mark.parametrize("title,content,published",[
    ("the title", "the new content",True),
    ("favorite games", "i like open world games",True),
    ("hobby","i love travelling in the mountains",True),
    ])
...
def test_update_post(authorized_client,test_user,test_posts):
    data = {
        "title": "Travelling",
        "content": "Top travelling spots in the world",
        "id": test_posts[0].id
    }
...
def test_update_other_user_post(authorized_client,test_user,test_user2,test_posts):
    ...
    data = {
        ...
        "content": "GTA 6 is coming next year",
        "id": test_posts[3].id
    }
